    ...
    var locations=[ ['<div class="infobox"><h3 class="title"><a href="#">OUR USA OFFICE</a></h3><span>Jaipur</span><span>+7009851021</span></div>',
    26.9124,
    75.7873,
    2]];
    var map=new google.maps.Map(document.getElementById('map'), {
        ...
        ], center: new google.maps.LatLng(26.9124,75.7873,), mapTypeId: google.maps.MapTypeId.ROADMAP
    }
